    ...
    <div className="min-h-screen bg-[#FAFAFA] flex items-center justify-center px-4">
      <div className="w-full max-w-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <Link href="/onboarding/person/step1" className="card-static p-6 text-center hover:shadow-md transition-all group">
          ...
          <Link href="/onboarding/company/step1" className="card-static p-6 text-center hover:shadow-md transition-all group">
            <div className="w-12 h-12 rounded-2xl bg-[#0F0F0F] text-white flex items-center justify-center mx-auto mb-4 group-hover:bg-[#FFD60A] group-hover:text-[#0F0F0F] transition-all">
